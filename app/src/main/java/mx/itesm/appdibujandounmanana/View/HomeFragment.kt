...
class HomeFragment : Fragment(), HomeCardListener {
    ...
    private fun fillRecyclerView(): ArrayList<HomeCardModel>{
        ...
        if(Locale.getDefault().displayLanguage == "español"){
            ...
            infoCards.add(HomeCardModel("Ayuda humanitaria", R.drawable.ayuda_humanitaria, "Proporcionar una respuesta de emergencia a través de la ayuda humanitaria a los afectados por las catástrofes naturales.", R.color.redDUM))
        }else{
