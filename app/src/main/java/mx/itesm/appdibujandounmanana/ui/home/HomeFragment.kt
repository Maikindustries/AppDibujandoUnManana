...
class HomeFragment : Fragment(), HomeCardListener {
    ...
    private fun fillRecyclerView(): ArrayList<HomeCardModel>{
        ...
        infoCards.add(HomeCardModel("Salud", R.drawable.salud,getString(R.string.salud), R.color.mustardDum))
        infoCards.add(HomeCardModel("Prevención", R.drawable.prevencion, getString(R.string.prevencion), R.color.teal_200))
        infoCards.add(HomeCardModel("Protección", R.drawable.proteccion, getString(R.string.proteccion), R.color.grayDum))
        infoCards.add(HomeCardModel("Género", R.drawable.genero, getString(R.string.genero), R.color.orangeDUM))
        infoCards.add(HomeCardModel("Ayuda humanitaria", R.drawable.ayuda_humanitaria, getString(R.string.ayuda_h), R.color.redDUM))
        return infoCards
    }
